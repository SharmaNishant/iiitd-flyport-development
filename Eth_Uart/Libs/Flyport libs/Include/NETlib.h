...
#define ETHCustomSave 		NETCustomSave
#define ETHCustomDelete 	NETCustomDelete
#define ETHCustomLoad		NETCustomLoad
#define ETHCustomExist		NETCustomExist
#define ETHSetParam			NETSetParam
