...
int HiloStdModeOn(long int baud)
{
	...
	{
		#if defined	(STACK_USE_UART)
		UARTWrite(1, "AT+CREG=0 OK\r\n");
		#endif
	}
	else
	{
		#if defined	(STACK_USE_UART)
		UARTWrite(1, "AT+CREG=0 ERROR\r\n");
		#endif
		return OP_SYNTAX_ERR;
	}
	...
	{
		#if defined	(STACK_USE_UART)
		UARTWrite(1, "AT+CRC=0 OK\r\n");
		#endif
	}
	else
	{
		#if defined	(STACK_USE_UART)
		UARTWrite(1, "AT+CRC=0 ERROR\r\n");
		#endif
		return OP_SYNTAX_ERR;
	}
	...
	{
		#if defined	(STACK_USE_UART)
		UARTWrite(1, "AT+CAOC=0 OK\r\n");
		#endif
	}
	else
	{
		#if defined	(STACK_USE_UART)
		UARTWrite(1, "AT+CAOC=0 ERROR\r\n");
		#endif
		return OP_SYNTAX_ERR;
	}
	...
	{
		#if defined	(STACK_USE_UART)
		UARTWrite(1, "AT+CCWA=0 OK\r\n");
		#endif
	}
	else
	{
		#if defined	(STACK_USE_UART)
		UARTWrite(1, "AT+CCWA=0 ERROR\r\n");
		#endif
		return OP_SYNTAX_ERR;
	}
	...
	{
		#if defined	(STACK_USE_UART)
		UARTWrite(1, "AT+CNMI=2,1,0,1 OK\r\n");
		#endif
	}
	else
	{
		#if defined	(STACK_USE_UART)
		UARTWrite(1, "AT+CNMI=2,1,0,1 ERROR\r\n");
		#endif
		return OP_SYNTAX_ERR;
	}
	...
	{
		#if defined	(STACK_USE_UART)
		UARTWrite(1, "AT+CSMP=17,167,0,0 OK\r\n");
		#endif
	}
	else
	{
		#if defined	(STACK_USE_UART)
		UARTWrite(1, "AT+CSMP=17,167,0,0 ERROR\r\n");
		#endif
		return OP_SYNTAX_ERR;
	}
	...
	{
		#if defined	(STACK_USE_UART)
		UARTWrite(1, "AT+CUSD=0 OK\r\n");
		#endif
	}
	else
	{
		#if defined	(STACK_USE_UART)
		UARTWrite(1, "AT+CUSD=0 ERROR\r\n");
		#endif
		return OP_SYNTAX_ERR;
	}
	...
	{
		#if defined	(STACK_USE_UART)
		UARTWrite(1, "AT+CLIP=1 OK\r\n");
		#endif
	}
	else
	{
		#if defined	(STACK_USE_UART)
		UARTWrite(1, "AT+CLIP=1 ERROR\r\n");
		#endif
		return OP_SYNTAX_ERR;
	}
	...
	{
		#if defined	(STACK_USE_UART)
		UARTWrite(1, "AT+KPATTERN=\"--EOF--Pattern--\" OK\r\n");
		#endif
	}
	else
	{
		#if defined	(STACK_USE_UART)
		UARTWrite(1, "AT+KPATTERN=\"--EOF--Pattern--\" ERROR\r\n");
		#endif
		return OP_SYNTAX_ERR;
	}
	...
	{
		#if defined	(STACK_USE_UART)
		UARTWrite(1, "AT+CSDH=1 OK\r\n");
		#endif
	}
	else
	{
		#if defined	(STACK_USE_UART)
		UARTWrite(1, "AT+CSDH=1 ERROR\r\n");
		#endif
		return OP_SYNTAX_ERR;
	}
	...
	{
		#if defined	(STACK_USE_UART)
		UARTWrite(1, "AT+CMGF=1 OK\r\n");
		#endif
	}
	else
	{
		#if defined	(STACK_USE_UART)
		UARTWrite(1, "AT+CMGF=1 ERROR\r\n");
		#endif
		return OP_SYNTAX_ERR;
	}
	...
	{
		#if defined	(STACK_USE_UART)
		UARTWrite(1, "AT+CREG=1 OK\r\n");
		#endif
	}
	else
	{
		#if defined	(STACK_USE_UART)
		UARTWrite(1, "AT+CREG=1 ERROR\r\n");
		#endif
		return OP_SYNTAX_ERR;
	}
	...
	{
		#if defined	(STACK_USE_UART)
		UARTWrite(1, "AT+KSLEEP=0 OK\r\n");
		#endif
	}
	else
	{
		#if defined	(STACK_USE_UART)
		UARTWrite(1, "AT+KSLEEP=0 ERROR\r\n");
		#endif
		return OP_SYNTAX_ERR;
	}
		...
		while(GSMBufferSize() > 0)
		{
			...
			if(strstr(unsolStr, "RING")!=NULL)
			{
				...
				if(res == -1)
				{
					//ERROR:
					#if defined(STACK_USE_UART)
					UARTWrite(1, "ERROR GSMReadN RING:\r\n");
					#endif
				...
				else
				{
					...
					{
						#if defined(STACK_USE_UART)
						UARTWrite(1, "ERROR getfield RING\r\n");
						#endif
						// Execute Error Handler
						ErrorHandler(errorType);						
						break;
			...
			else if(strstr(unsolStr, "NO C")!=NULL)
			{
				...
				if(res == -1)
				{
					//ERROR:
					#if defined(STACK_USE_UART)
					UARTWrite(1, "ERROR GSMReadN NO CARRIER\r\n");
					#endif
			...
			else if(strstr(unsolStr, "BUSY")!=NULL)
			{
				...
				if(res == -1)
				{
					// ERROR:
					#if defined(STACK_USE_UART)
					UARTWrite(1, "ERROR GSMReadN BUSY\r\n");
					#endif
			...
			else if(strstr(unsolStr, "+CMS")!=NULL)
			{
				...
				{
					#if defined(STACK_USE_UART)
					UARTWrite(1, "ERROR GSMReadN +CMS\r\n");
					#endif
			...
			else if(strstr(unsolStr, "+CME")!=NULL)
			{
				...
				if(res == -1)
				{
					//ERROR:
					#if defined(STACK_USE_UART)
					UARTWrite(1, "ERROR GSMReadN +CME\r\n");
					#endif
			...
			else if(strstr(unsolStr, "+CMT")!=NULL)
			{
				...
				if(res == -1)
				{
					//ERROR:
					#if defined(STACK_USE_UART)
					UARTWrite(1, "ERROR GSMReadN +CMTI\r\n");
					#endif
			...
			else if(strstr(unsolStr, "+CDS")!=NULL)
			{
				...
				if(res == -1)
				{
					//ERROR:
					#if defined(STACK_USE_UART)
					UARTWrite(1, "ERROR GSMReadN +CDS\r\n");
					#endif
			...
			else if(strstr(unsolStr, "+CRE")!=NULL)
			{
				...
				if(res == -1)
				{
					//ERROR:
					#if defined(STACK_USE_UART)
					UARTWrite(1, "ERROR GSMReadN +CREG\r\n");
					#endif
			...
			else if(strstr(unsolStr, "+KTC")!=NULL)
			{
				...
				{			
					...
					if(res == -1)
					{
						//ERROR:
						#if defined(STACK_USE_UART)
						UARTWrite(1, "ERROR GSMReadN +KTCP_NOTIF\r\n");
						#endif
				...
				else if(strstr(UnsolBuffer, "P_DATA:") != NULL)// Ignore +KTCP_DATA
				{
					...
					if(res == -1)
					{
						//ERROR:
						#if defined(STACK_USE_UART)
						UARTWrite(1, "ERROR GSMReadN +KTCP_DATA\r\n");
						#endif
			...
			else if(strstr(unsolStr, "+KFT")!=NULL)
			{
				...
				{			
					...
					if(res == -1)
					{
						//ERROR:
						#if defined(STACK_USE_UART)
						UARTWrite(1, "ERROR GSMReadN +KFTP_ERROR\r\n");
						#endif
...
void ErrorHandler(int errorType)
{
	...
	if(mainGSMStateMachine == SM_GSM_IDLE)
	{
		...
		#if defined(STACK_USE_UART)
		UARTWrite(1, "generic error on message received!\r\n");
		#endif
	}
